...
@Component({
  selector: 'app-view-higher-bill-orders',
  templateUrl: './view-higher-bill-orders.component.html',
  styleUrls: ['./view-higher-bill-orders.component.scss']
})
export class ViewHigherBillOrdersComponent implements OnInit {
  ...
  public onChangeStatus(event): void {
    ...
    if (status == null || status == "") {
      ...
      this.getHigherBillOrderDataByStatus(status);
  }

  getHigherBillOrderDataByStatus(status: String) {
    this.type = "HigherBill";
  ...
  public onChangeSupplier(event): void {
    ...
    if (supplier == null || supplier == "") {
      ...
      this.getHigherBillOrderDataBySupplier(supplier);
  }

  getHigherBillOrderDataBySupplier(supplier: String) {
    this.type = "HigherBill";
  ...
  getHigherBillOrderDataByOrderId(orderID: String) {
    this.type = "HigherBill";
  ...
  public onClickSearchByOrderId(orderID): void {
    ...
    if (id == null || id == "") {
      ...
      this.getHigherBillOrderDataByOrderId(id);
  }
